...
I enjoy thinking about ways to make the interface between us and our computational tools as streamlined and smooth as possible. The reason why R is my favourite programming language is because it makes it exceptionally easy to build elegant interfaces to other libraries and tools (even when these are less user-friendly than would be desirable). This path has started with me building a modest R interface for the widely used ADMIXTOOLS software, implemented in the R package [_admixr_](https://github.com/bodkan/admixr).
